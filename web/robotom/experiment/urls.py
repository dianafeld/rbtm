...
urlpatterns = patterns('',
                       ...
                       url(r'^tomograph/(?P<tomo_num>\d+)/set_angle$', views.set_angle,
                           name='set_angle'),
                       url(r'^tomograph/(?P<tomo_num>\d+)/power_on$', views.power_on,
                           name='power_on'),
                       url(r'^tomograph/(?P<tomo_num>\d+)/power_off$', views.power_off,
                           name='power_off'),
                       url(r'^tomograph/(?P<tomo_num>\d+)/experiment_start$', views.experiment_start,
                           name='experiment_start'),
                       url(r'^tomograph/(?P<tomo_num>\d+)/experiment_stop$', views.experiment_stop,
